...
@Component({
  templateUrl: './item-electronics.component.html',
})
export class ItemElectronicsComponent implements OnInit {
  products?: Product[];
  user:any;
  productList:any=[];
  itemList:any=[];
  ...
  ngOnInit(): void {
    this.productService.getAllProduct().subscribe((products) => {
      this.products = products.filter(x=>x.productCategory=='Electronics')
